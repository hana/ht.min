...
#include "ht.alarm_tilde.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<ht_alarm_tilde> an_instance;
        ht_alarm_tilde&              my_object = an_instance;
