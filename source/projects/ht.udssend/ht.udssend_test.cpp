...
#include "ht.udssend.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<ht_min_udssend> an_instance;
        ht_min_udssend&              my_object = an_instance;
