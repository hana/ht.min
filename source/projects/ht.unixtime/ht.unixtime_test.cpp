...
#include "ht.unixtime.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<ht_min_unixtime> an_instance;
        ht_min_unixtime&              my_object = an_instance;
