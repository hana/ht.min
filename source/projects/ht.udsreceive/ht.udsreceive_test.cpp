...
#include "ht.udsreceive.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<ht_udsreceive> an_instance;
        ht_udsreceive&              my_object = an_instance;
